...
.method protected cancel()V
    ...
    invoke-interface {v0, p0}, Landroid/support/transition/TransitionPort$TransitionListener;->onTransitionCancel(Landroid/support/transition/TransitionPort;)V
...
.method public clone()Landroid/support/transition/TransitionPort;
    ...
    iput-object v0, v2, Landroid/support/transition/TransitionPort;->mStartValues:Landroid/support/transition/TransitionValuesMaps;
    ...
    iput-object v0, v2, Landroid/support/transition/TransitionPort;->mEndValues:Landroid/support/transition/TransitionValuesMaps;
    :try_end_0
...
.method protected createAnimators(Landroid/view/ViewGroup;Landroid/support/transition/TransitionValuesMaps;Landroid/support/transition/TransitionValuesMaps;)V
    ...
    invoke-direct {v4, v0}, Landroid/support/v4/util/ArrayMap;-><init>(Landroid/support/v4/util/SimpleArrayMap;)V
    ...
    .line 218
    invoke-virtual {v4, v10}, Landroid/support/v4/util/ArrayMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 228
    invoke-virtual {v4, v15}, Landroid/support/v4/util/ArrayMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    .line 231
    :cond_7
    :goto_5
    invoke-virtual {v5, v14}, Landroid/util/SparseArray;->remove(I)V
    ...
    invoke-virtual {v2, v10, v0, v1}, Landroid/support/transition/TransitionPort;->isValidTarget(Landroid/view/View;J)Z
    ...
    .line 239
    invoke-virtual {v14, v10}, Landroid/widget/ListView;->getPositionForView(Landroid/view/View;)I

    move-result v15

    .line 240
    invoke-virtual {v14, v15}, Landroid/widget/ListView;->getItemIdAtPosition(I)J
    ...
    invoke-virtual {v6, v0, v1}, Landroid/support/v4/util/LongSparseArray;->remove(J)V
    ...
    invoke-virtual {v0, v10}, Landroid/support/v4/util/LongSparseArray;->keyAt(I)J
    ...
    invoke-virtual {v0, v1, v11, v12}, Landroid/support/transition/TransitionPort;->isValidTarget(Landroid/view/View;J)Z
    ...
    invoke-virtual {v0, v11, v12}, Landroid/support/v4/util/LongSparseArray;->get(J)Ljava/lang/Object;
    ...
    .line 255
    invoke-virtual {v6, v11, v12}, Landroid/support/v4/util/LongSparseArray;->remove(J)V
    ...
    .line 266
    :goto_8
    invoke-virtual {v4, v11}, Landroid/support/v4/util/ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 284
    invoke-virtual {v6, v12}, Landroid/support/v4/util/LongSparseArray;->keyAt(I)J
    ...
    .line 287
    invoke-virtual {v6, v13, v14}, Landroid/support/v4/util/LongSparseArray;->get(J)Ljava/lang/Object;
    ...
    invoke-virtual {v14, v15}, Landroid/support/transition/TransitionValues;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0, v1, v14, v15}, Landroid/support/transition/TransitionPort;->createAnimator(Landroid/view/ViewGroup;Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    .line 326
    new-instance p2, Landroid/support/transition/TransitionValues;

    invoke-direct/range {p2 .. p2}, Landroid/support/transition/TransitionValues;-><init>()V
    ...
    iget-object v2, v5, Landroid/support/transition/TransitionValues;->values:Ljava/util/Map;
    ...
    .line 335
    :cond_16
    invoke-virtual {v12}, Landroid/support/v4/util/ArrayMap;->size()I
    ...
    .line 337
    invoke-virtual {v12, v4}, Landroid/support/v4/util/ArrayMap;->keyAt(I)Ljava/lang/Object;
    ...
    .line 338
    invoke-virtual {v12, v5}, Landroid/support/v4/util/ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 339
    iget-object v0, v5, Landroid/support/transition/TransitionPort$AnimationInfo;->values:Landroid/support/transition/TransitionValues;
    ...
    iget-object v0, v5, Landroid/support/transition/TransitionPort$AnimationInfo;->name:Ljava/lang/String;
    ...
    .line 351
    :cond_1b
    iget-object v0, v14, Landroid/support/transition/TransitionValues;->view:Landroid/view/View;
    ...
    invoke-direct {v4, v2, v0, v1, v3}, Landroid/support/transition/TransitionPort$AnimationInfo;-><init>(Landroid/view/View;Ljava/lang/String;Landroid/support/transition/WindowIdPort;Landroid/support/transition/TransitionValues;)V

    .line 356
    move-object/from16 v0, v16

    invoke-virtual {v12, v0, v4}, Landroid/support/v4/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public getTransitionValues(Landroid/view/View;Z)Landroid/support/transition/TransitionValues;
    ...
    .line 786
    iget-object v0, p2, Landroid/support/transition/TransitionValuesMaps;->itemIdValues:Landroid/support/v4/util/LongSparseArray;
...
.method public pause(Landroid/view/View;)V
    ...
    .line 809
    iget-object v0, v3, Landroid/support/transition/TransitionPort$AnimationInfo;->view:Landroid/view/View;

    if-eqz v0, :cond_0

    iget-object v0, v3, Landroid/support/transition/TransitionPort$AnimationInfo;->windowId:Landroid/support/transition/WindowIdPort;

    invoke-virtual {p1, v0}, Landroid/support/transition/WindowIdPort;->equals(Ljava/lang/Object;)Z
...
.method playTransition(Landroid/view/ViewGroup;)V
    ...
    .line 869
    invoke-virtual {v2, v3}, Landroid/support/v4/util/ArrayMap;->keyAt(I)Ljava/lang/Object;
    ...
    .line 875
    iget-object v7, v5, Landroid/support/transition/TransitionPort$AnimationInfo;->values:Landroid/support/transition/TransitionValues;

    .line 876
    iget-object v5, v5, Landroid/support/transition/TransitionPort$AnimationInfo;->view:Landroid/view/View;
    ...
    .line 912
    :cond_5
    invoke-virtual {v2, v4}, Landroid/support/v4/util/ArrayMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;
