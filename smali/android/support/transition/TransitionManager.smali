...
.method public static go(Landroid/support/transition/Scene;Landroid/support/transition/Transition;)V
    ...
    :cond_0
    iget-object v2, p1, Landroid/support/transition/Transition;->mImpl:Landroid/support/transition/TransitionImpl;

    :goto_0
    invoke-virtual {v0, v1, v2}, Landroid/support/transition/TransitionManagerStaticsImpl;->go(Landroid/support/transition/SceneImpl;Landroid/support/transition/TransitionImpl;)V
...
.method public setTransition(Landroid/support/transition/Scene;Landroid/support/transition/Scene;Landroid/support/transition/Transition;)V
    ...
    iget-object v2, p2, Landroid/support/transition/Scene;->mImpl:Landroid/support/transition/SceneImpl;
    ...
    :cond_0
    iget-object v3, p3, Landroid/support/transition/Transition;->mImpl:Landroid/support/transition/TransitionImpl;

    :goto_0
    invoke-virtual {v0, v1, v2, v3}, Landroid/support/transition/TransitionManagerImpl;->setTransition(Landroid/support/transition/SceneImpl;Landroid/support/transition/SceneImpl;Landroid/support/transition/TransitionImpl;)V
...
.method public setTransition(Landroid/support/transition/Scene;Landroid/support/transition/Transition;)V
    ...
    :cond_0
    iget-object v2, p2, Landroid/support/transition/Transition;->mImpl:Landroid/support/transition/TransitionImpl;

    :goto_0
    invoke-virtual {v0, v1, v2}, Landroid/support/transition/TransitionManagerImpl;->setTransition(Landroid/support/transition/SceneImpl;Landroid/support/transition/TransitionImpl;)V
