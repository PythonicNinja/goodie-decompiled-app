...
.method public addCallback(Landroid/support/design/widget/BaseTransientBottomBar$BaseCallback;)Landroid/support/design/widget/BaseTransientBottomBar;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Landroid/support/design/widget/BaseTransientBottomBar$BaseCallback<TB;>;)TB;"
        }
    .end annotation
...
.method final showView()V
    ...
    .line 405
    new-instance v3, Landroid/support/design/widget/BaseTransientBottomBar$Behavior;

    invoke-direct {v3, p0}, Landroid/support/design/widget/BaseTransientBottomBar$Behavior;-><init>(Landroid/support/design/widget/BaseTransientBottomBar;)V

    .line 406
    const v0, 0x3dcccccd    # 0.1f

    invoke-virtual {v3, v0}, Landroid/support/design/widget/BaseTransientBottomBar$Behavior;->setStartAlphaSwipeDistance(F)V

    .line 407
    const v0, 0x3f19999a    # 0.6f

    invoke-virtual {v3, v0}, Landroid/support/design/widget/BaseTransientBottomBar$Behavior;->setEndAlphaSwipeDistance(F)V

    .line 408
    const/4 v0, 0x0

    invoke-virtual {v3, v0}, Landroid/support/design/widget/BaseTransientBottomBar$Behavior;->setSwipeDirection(I)V
    ...
    invoke-virtual {v3, v0}, Landroid/support/design/widget/BaseTransientBottomBar$Behavior;->setListener(Landroid/support/design/widget/SwipeDismissBehavior$OnDismissListener;)V

    .line 431
    invoke-virtual {v2, v3}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->setBehavior(Landroid/support/design/widget/CoordinatorLayout$Behavior;)V
