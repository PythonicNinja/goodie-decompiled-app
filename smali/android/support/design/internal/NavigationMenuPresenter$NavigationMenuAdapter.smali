...
.annotation system Ldalvik/annotation/Signature;
    value = {
        "Landroid/support/v7/widget/RecyclerView$Adapter<Landroid/support/design/internal/NavigationMenuPresenter$ViewHolder;>;"
    }
.end annotation
...
.field private final mItems:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuItem;>;"
        }
    .end annotation
.end field
...
.method private prepareMenuItems()V
    ...
    invoke-virtual {v9, v0}, Landroid/support/v7/view/menu/MenuItemImpl;->setExclusiveCheckable(Z)V
    ...
    new-instance v1, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuSeparatorItem;

    move-object/from16 v2, p0

    iget-object v2, v2, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->this$0:Landroid/support/design/internal/NavigationMenuPresenter;

    iget v2, v2, Landroid/support/design/internal/NavigationMenuPresenter;->mPaddingSeparator:I

    const/4 v3, 0x0

    invoke-direct {v1, v2, v3}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuSeparatorItem;-><init>(II)V
    ...
    invoke-direct {v1, v9}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuTextItem;-><init>(Landroid/support/v7/view/menu/MenuItemImpl;)V
    ...
    invoke-virtual {v15, v0}, Landroid/support/v7/view/menu/MenuItemImpl;->setExclusiveCheckable(Z)V
    ...
    invoke-direct {v1, v15}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuTextItem;-><init>(Landroid/support/v7/view/menu/MenuItemImpl;)V
    ...
    invoke-direct {v1, v12, v0}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->appendTransparentIconIfMissing(II)V
    ...
    iget-object v3, v3, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->this$0:Landroid/support/design/internal/NavigationMenuPresenter;

    iget v3, v3, Landroid/support/design/internal/NavigationMenuPresenter;->mPaddingSeparator:I
    ...
    invoke-direct {v1, v5, v0}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->appendTransparentIconIfMissing(II)V
    ...
    invoke-direct {v11, v9}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuTextItem;-><init>(Landroid/support/v7/view/menu/MenuItemImpl;)V

    .line 530
    iput-boolean v6, v11, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuTextItem;->needsEmptyIcon:Z
...
.method public createInstanceState()Landroid/os/Bundle;
    ...
    .line 564
    instance-of v0, v5, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuTextItem;
...
.method public onBindViewHolder(Landroid/support/design/internal/NavigationMenuPresenter$ViewHolder;I)V
    ...
    invoke-virtual {v5, v0}, Landroid/support/design/internal/NavigationMenuItemView;->setIconTintList(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v5, v0}, Landroid/support/design/internal/NavigationMenuItemView;->setTextAppearance(I)V
    ...
    invoke-virtual {v5, v0}, Landroid/support/design/internal/NavigationMenuItemView;->setTextColor(Landroid/content/res/ColorStateList;)V
    ...
    .line 425
    :goto_0
    invoke-static {v5, v0}, Landroid/support/v4/view/ViewCompat;->setBackground(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 428
    iget-boolean v0, p1, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuTextItem;->needsEmptyIcon:Z

    invoke-virtual {v5, v0}, Landroid/support/design/internal/NavigationMenuItemView;->setNeedsEmptyIcon(Z)V
    ...
    invoke-virtual {v5}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuSeparatorItem;->getPaddingTop()I

    move-result v1

    .line 442
    invoke-virtual {v5}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuSeparatorItem;->getPaddingBottom()I
...
.method public bridge synthetic onBindViewHolder(Landroid/support/v7/widget/RecyclerView$ViewHolder;I)V
    ...
    check-cast v0, Landroid/support/design/internal/NavigationMenuPresenter$ViewHolder;
...
.method public restoreInstanceState(Landroid/os/Bundle;)V
    ...
    .line 583
    instance-of v0, v4, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuTextItem;
