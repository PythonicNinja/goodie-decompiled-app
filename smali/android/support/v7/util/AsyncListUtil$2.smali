...
.annotation system Ldalvik/annotation/Signature;
    value = {
        "Ljava/lang/Object;Landroid/support/v7/util/ThreadUtil$BackgroundCallback<TT;>;"
    }
.end annotation
...
.method private acquireTile()Landroid/support/v7/util/TileList$Tile;
    ...
    .line 389
    iget-object v3, p0, Landroid/support/v7/util/AsyncListUtil$2;->mRecycledRoot:Landroid/support/v7/util/TileList$Tile;
...
.method private addTile(Landroid/support/v7/util/TileList$Tile;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Landroid/support/v7/util/TileList$Tile<TT;>;)V"
        }
    .end annotation
...
.method private flushTileCache(I)V
    ...
    .line 422
    iget v0, p0, Landroid/support/v7/util/AsyncListUtil$2;->mLastRequiredTileStart:I
    ...
    .line 428
    :cond_2
    invoke-direct {p0, v5}, Landroid/support/v7/util/AsyncListUtil$2;->removeTile(I)V
...
.method private requestTiles(IIIZ)V
    ...
    invoke-interface {v0, v2, p3}, Landroid/support/v7/util/ThreadUtil$BackgroundCallback;->loadTile(II)V
...
.method public loadTile(II)V
    ...
    .line 369
    iput p1, v4, Landroid/support/v7/util/TileList$Tile;->mStartPosition:I
    ...
    iget v2, v4, Landroid/support/v7/util/TileList$Tile;->mStartPosition:I
    ...
    iput v0, v4, Landroid/support/v7/util/TileList$Tile;->mItemCount:I
    ...
    iget-object v1, v4, Landroid/support/v7/util/TileList$Tile;->mItems:[Ljava/lang/Object;

    iget v2, v4, Landroid/support/v7/util/TileList$Tile;->mStartPosition:I

    iget v3, v4, Landroid/support/v7/util/TileList$Tile;->mItemCount:I

    invoke-virtual {v0, v1, v2, v3}, Landroid/support/v7/util/AsyncListUtil$DataCallback;->fillData([Ljava/lang/Object;II)V

    .line 372
    invoke-direct {p0, p2}, Landroid/support/v7/util/AsyncListUtil$2;->flushTileCache(I)V

    .line 373
    invoke-direct {p0, v4}, Landroid/support/v7/util/AsyncListUtil$2;->addTile(Landroid/support/v7/util/TileList$Tile;)V
...
.method public updateRange(IIIII)V
    ...
    iput v0, p0, Landroid/support/v7/util/AsyncListUtil$2;->mFirstRequiredTileStart:I
    ...
    iput v0, p0, Landroid/support/v7/util/AsyncListUtil$2;->mLastRequiredTileStart:I
    ...
    invoke-direct {p0, v0, p2, p5, v1}, Landroid/support/v7/util/AsyncListUtil$2;->requestTiles(IIIZ)V
    ...
    invoke-direct {p0, v0, v1, p5, v2}, Landroid/support/v7/util/AsyncListUtil$2;->requestTiles(IIIZ)V
    ...
    invoke-direct {p0, p1, v0, p5, v1}, Landroid/support/v7/util/AsyncListUtil$2;->requestTiles(IIIZ)V
