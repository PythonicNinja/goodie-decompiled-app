...
.annotation system Ldalvik/annotation/Signature;
    value = {
        "Ljava/lang/Object;Lcom/facebook/stetho/common/android/DialogFragmentAccessor<Landroid/app/DialogFragment;Landroid/app/Fragment;Landroid/app/FragmentManager;>;"
    }
.end annotation
...
.field private final mFragmentAccessor:Lcom/facebook/stetho/common/android/FragmentAccessor;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/facebook/stetho/common/android/FragmentAccessor<Landroid/app/Fragment;Landroid/app/FragmentManager;>;"
        }
    .end annotation
.end field
...
.method public constructor <init>(Lcom/facebook/stetho/common/android/FragmentAccessor;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lcom/facebook/stetho/common/android/FragmentAccessor<Landroid/app/Fragment;Landroid/app/FragmentManager;>;)V"
        }
    .end annotation
...
.method public bridge synthetic getChildFragmentManager(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0}, Lcom/facebook/stetho/common/android/FragmentCompatFramework$DialogFragmentAccessorFramework;->getChildFragmentManager(Landroid/app/Fragment;)Landroid/app/FragmentManager;
...
.method public bridge synthetic getDialog(Ljava/lang/Object;)Landroid/app/Dialog;
    ...
    invoke-virtual {p0, v0}, Lcom/facebook/stetho/common/android/FragmentCompatFramework$DialogFragmentAccessorFramework;->getDialog(Landroid/app/DialogFragment;)Landroid/app/Dialog;
...
.method public bridge synthetic getFragmentManager(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0}, Lcom/facebook/stetho/common/android/FragmentCompatFramework$DialogFragmentAccessorFramework;->getFragmentManager(Landroid/app/Fragment;)Landroid/app/FragmentManager;
...
.method public bridge synthetic getId(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, v0}, Lcom/facebook/stetho/common/android/FragmentCompatFramework$DialogFragmentAccessorFramework;->getId(Landroid/app/Fragment;)I
...
.method public bridge synthetic getResources(Ljava/lang/Object;)Landroid/content/res/Resources;
    ...
    invoke-virtual {p0, v0}, Lcom/facebook/stetho/common/android/FragmentCompatFramework$DialogFragmentAccessorFramework;->getResources(Landroid/app/Fragment;)Landroid/content/res/Resources;
...
.method public bridge synthetic getTag(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/facebook/stetho/common/android/FragmentCompatFramework$DialogFragmentAccessorFramework;->getTag(Landroid/app/Fragment;)Ljava/lang/String;
...
.method public bridge synthetic getView(Ljava/lang/Object;)Landroid/view/View;
    ...
    invoke-virtual {p0, v0}, Lcom/facebook/stetho/common/android/FragmentCompatFramework$DialogFragmentAccessorFramework;->getView(Landroid/app/Fragment;)Landroid/view/View;
