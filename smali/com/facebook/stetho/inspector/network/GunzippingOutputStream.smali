...
.method private constructor <init>(Ljava/io/OutputStream;Ljava/util/concurrent/Future;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Ljava/io/OutputStream;Ljava/util/concurrent/Future<Ljava/lang/Void;>;)V"
        }
    .end annotation
...
.method public static create(Ljava/io/OutputStream;)Lcom/facebook/stetho/inspector/network/GunzippingOutputStream;
    ...
    .line 43
    sget-object v0, Lcom/facebook/stetho/inspector/network/GunzippingOutputStream;->sExecutor:Ljava/util/concurrent/ExecutorService;

    new-instance v1, Lcom/facebook/stetho/inspector/network/GunzippingOutputStream$GunzippingCallable;

    invoke-direct {v1, v2, p0}, Lcom/facebook/stetho/inspector/network/GunzippingOutputStream$GunzippingCallable;-><init>(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    ...
    invoke-direct {v0, v3, p0}, Lcom/facebook/stetho/inspector/network/GunzippingOutputStream;-><init>(Ljava/io/OutputStream;Ljava/util/concurrent/Future;)V
...
.method private static getAndRethrow(Ljava/util/concurrent/Future;)Ljava/lang/Object;
    ...
    invoke-static {v1, v0}, Lcom/facebook/stetho/common/ExceptionUtil;->propagateIfInstanceOf(Ljava/lang/Throwable;Ljava/lang/Class;)V
