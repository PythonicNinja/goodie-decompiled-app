...
.method public run()V
    ...
    iget-object v1, p0, Lcom/facebook/stetho/inspector/protocol/module/DOM$2;->val$contentColor:Lcom/facebook/stetho/inspector/protocol/module/DOM$RGBAColor;

    invoke-virtual {v1}, Lcom/facebook/stetho/inspector/protocol/module/DOM$RGBAColor;->getColor()I

    move-result v1

    invoke-virtual {v0, v2, v1}, Lcom/facebook/stetho/inspector/elements/Document;->highlightElement(Ljava/lang/Object;I)V
