...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/Iterable;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Landroid/content/Context;Ljava/lang/Iterable<Lcom/facebook/stetho/inspector/protocol/ChromeDevtoolsDomain;>;)V"
        }
    .end annotation
...
.method private createServer()Lcom/facebook/stetho/server/http/LightHttpServer;
    ...
    .line 37
    new-instance v4, Lcom/facebook/stetho/server/http/HandlerRegistry;

    invoke-direct {v4}, Lcom/facebook/stetho/server/http/HandlerRegistry;-><init>()V

    .line 38
    new-instance v0, Lcom/facebook/stetho/inspector/ChromeDiscoveryHandler;

    iget-object v1, p0, Lcom/facebook/stetho/inspector/DevtoolsSocketHandler;->mContext:Landroid/content/Context;

    const-string v2, "/inspector"

    invoke-direct {v0, v1, v2}, Lcom/facebook/stetho/inspector/ChromeDiscoveryHandler;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    .line 42
    invoke-virtual {v0, v4}, Lcom/facebook/stetho/inspector/ChromeDiscoveryHandler;->register(Lcom/facebook/stetho/server/http/HandlerRegistry;)V
    ...
    new-instance v1, Lcom/facebook/stetho/websocket/WebSocketHandler;

    new-instance v2, Lcom/facebook/stetho/inspector/ChromeDevtoolsServer;

    iget-object v3, p0, Lcom/facebook/stetho/inspector/DevtoolsSocketHandler;->mModules:Ljava/lang/Iterable;

    invoke-direct {v2, v3}, Lcom/facebook/stetho/inspector/ChromeDevtoolsServer;-><init>(Ljava/lang/Iterable;)V

    invoke-direct {v1, v2}, Lcom/facebook/stetho/websocket/WebSocketHandler;-><init>(Lcom/facebook/stetho/websocket/SimpleEndpoint;)V

    invoke-virtual {v4, v0, v1}, Lcom/facebook/stetho/server/http/HandlerRegistry;->register(Lcom/facebook/stetho/server/http/PathMatcher;Lcom/facebook/stetho/server/http/HttpHandler;)V

    .line 47
    new-instance v0, Lcom/facebook/stetho/server/http/LightHttpServer;

    invoke-direct {v0, v4}, Lcom/facebook/stetho/server/http/LightHttpServer;-><init>(Lcom/facebook/stetho/server/http/HandlerRegistry;)V
