...
.method private toFixedFormat(II)V
    ...
    invoke-static {v0, p1, v0, v6, v1}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-static {v0, v1, v6, v2}, Ljava/util/Arrays;->fill([CIIC)V
...
.method public format()Ljava/lang/String;
    ...
    .line 43
    :cond_1
    invoke-direct {p0, v4, v5}, Lorg/mozilla/javascript/v8dtoa/FastDtoaBuilder;->toExponentialFormat(II)V

    goto :goto_1

    .line 45
    :cond_2
    invoke-direct {p0, v4, v5}, Lorg/mozilla/javascript/v8dtoa/FastDtoaBuilder;->toFixedFormat(II)V
