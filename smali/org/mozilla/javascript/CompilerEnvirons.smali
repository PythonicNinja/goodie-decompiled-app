...
.method public static ideEnvirons()Lorg/mozilla/javascript/CompilerEnvirons;
    ...
    invoke-virtual {v1, v0}, Lorg/mozilla/javascript/CompilerEnvirons;->setRecoverFromErrors(Z)V

    .line 266
    const/4 v0, 0x1

    invoke-virtual {v1, v0}, Lorg/mozilla/javascript/CompilerEnvirons;->setRecordingComments(Z)V

    .line 267
    const/4 v0, 0x1

    invoke-virtual {v1, v0}, Lorg/mozilla/javascript/CompilerEnvirons;->setStrictMode(Z)V

    .line 268
    const/4 v0, 0x1

    invoke-virtual {v1, v0}, Lorg/mozilla/javascript/CompilerEnvirons;->setWarnTrailingComma(Z)V

    .line 269
    const/16 v0, 0xaa

    invoke-virtual {v1, v0}, Lorg/mozilla/javascript/CompilerEnvirons;->setLanguageVersion(I)V

    .line 270
    const/4 v0, 0x1

    invoke-virtual {v1, v0}, Lorg/mozilla/javascript/CompilerEnvirons;->setReservedKeywordAsIdentifier(Z)V

    .line 271
    const/4 v0, 0x1

    invoke-virtual {v1, v0}, Lorg/mozilla/javascript/CompilerEnvirons;->setIdeMode(Z)V

    .line 272
    new-instance v0, Lorg/mozilla/javascript/ast/ErrorCollector;

    invoke-direct {v0}, Lorg/mozilla/javascript/ast/ErrorCollector;-><init>()V

    invoke-virtual {v1, v0}, Lorg/mozilla/javascript/CompilerEnvirons;->setErrorReporter(Lorg/mozilla/javascript/ErrorReporter;)V
